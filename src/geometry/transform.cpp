...
Transform::Transform(const KDL::Frame& frame, const std::string& frame_id, const std::string& ref_frame_id)
  : frame_(frame), frame_id_(frame_id), ref_frame_id_(ref_frame_id)
...
Transform::Transform(const KDL::Vector& position, const KDL::Rotation& rotation, const std::string& frame_id,
  ...
  : frame_(KDL::Frame(rotation, position)), frame_id_(frame_id), ref_frame_id_(ref_frame_id)
{
}

Transform::Transform(const Eigen::Isometry3d& frame, const std::string& frame_id, const std::string& ref_frame_id)
  : frame_(transformEigenToKDL(frame)), frame_id_(frame_id), ref_frame_id_(ref_frame_id)
{
}
...
Transform::Transform(double px, double py, double pz, double qx, double qy, double qz, double qw,
                     const std::string& frame_id, const std::string& ref_frame_id)
...
Transform::Transform(const geometry_msgs::TransformStamped& frame, const std::string& frame_id,
                     const std::string& ref_frame_id)
  : frame_(tf2::transformToKDL(frame)), frame_id_(frame.header.frame_id), ref_frame_id_(ref_frame_id)
{
}
...
Transform::Transform(const geometry_msgs::Pose& frame, const std::string& frame_id, const std::string& ref_frame_id)
...
const std::string& Transform::refFrameId() const
{
